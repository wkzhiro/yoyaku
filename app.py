...
page = st.sidebar.selectbox('Choose yout page', ['users','rooms','bookings'] )
...
if page == 'users':
    ...
    if submit_button:
        ...
        if booked_num > capacity:
            st.error(f'{room_name}の定員は、{capacity}名以下の予約人数のみ受け付けております。')
